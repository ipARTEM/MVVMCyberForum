...
namespace MVVMCyberForum
{
    ...
    public class FuzzySearch_VM_DataDesigner : OnPropertyChangedClass
    {
        ...
        public string TextAdd { get => _textAdd; set { _textAdd = value; OnPropertyChanged(); } }
        /// <summary>Свойство для списка слова!!!</summary>
        public ObservableCollection<string> ListWords { get => _listWords; set { _listWords = value; OnPropertyChanged(); } }
        /// <summary>Свойство для сообщения с результатами поиска</summary>
        public string TextMessage { get => _textMessage; set { _textMessage = value; OnPropertyChanged(); } }
        #endregion
